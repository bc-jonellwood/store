...
Last modified: 2024/09/27 09:19:20
    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-dark" data-bs-theme="dark">
            <div class="container-fluid align-items-baseline">
                ...
                <button class="navbar-toggler" type="button" popovertarget="navbar-popover" popovertargetaction="show" id="navbar-popover-toggle">
                    <span class="navbar-toggler-icon"></span>
                </button>
                <div class="collapse navbar-collapse" id="navbarColor02">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <button class="nav-link" href="#" popovertarget="mens-menu-popover" popovertargetaction="show" onclick="scrollToTop()"
                                id="mens-menu-anchor" role="button">MENS
                                <span class="visually-hidden">(current)</span>
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" href="#" popovertarget="womans-menu-popover" popovertargetaction="show" onclick="scrollToTop()"
