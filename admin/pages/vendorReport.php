...
// Last Modified: 2024/10/10 09:46:40
session_start();
                ...
                for (var i = 0; i < splitObjs.length; i++) {
                    ...
                    <div id="container">
                        <div id="header">
                            ...
                            <div class="deets">
                                ...
                                <span>Report Date: ${formatDate(splitObjs[i][0].order_placed)} </span><br>
                                <span>Vendor: ${splitObjs[i][0].vendor_name}</span><br>
                    ...
                    for (var j = 0; j < splitObjs[i].length; j++) {
                        html += `<tr>    
                                ...
                                <td>${splitObjs[i][j].color_name}</td>
